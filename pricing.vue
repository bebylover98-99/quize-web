...
export default {
  ...
  props: {
    ...
    plan1Feature1: {
      type: String,
      default: 'Warm-up round with 3 questions',
    },
    plan2Price1: {
      type: String,
      default: '$299/yr',
    ...
    plan3Feature3: {
      type: String,
      default: 'Customizable quiz options',
    },
    plan2: {
      type: String,
    ...
    plan3Feature1: {
      type: String,
      default: 'Exclusive access to all quiz features',
    },
    plan2Action: {
      type: String,
      default: 'Upgrade Now',
    ...
    plan2Feature2: {
      type: String,
      default: 'Requires 8 correct answers to proceed',
    },
    plan1Feature3: {
      type: String,
      default: 'Final round with 50 questions',
    },
    plan2Action1: {
      type: String,
      default: 'Get started',
    ...
    plan3Feature2: {
      type: String,
      default: 'Priority support for quiz inquiries',
    },
    content1: {
      type: String,
    ...
    plan2Feature3: {
      type: String,
      default: 'Access to all quiz rounds',
    },
    plan1Feature2: {
      type: String,
      default: 'Requires 2 correct answers to proceed',
    },
    plan3Action: {
      type: String,
      default: 'Upgrade Now',
    ...
    plan2Feature1: {
      type: String,
      default: 'Challenge round with 10 questions',
    },
    plan1Price: {
      type: String,
      default: '$9.99',
